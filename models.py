...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        _hazardous = 'not potentially hazardous' if self.hazardous else 'potentially hazardous'
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter} and is {_hazardous}."
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return (f"A CloseApproach {self.neo.fullname} approaches Earth at a distance of"
